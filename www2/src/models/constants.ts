export const QuranWords = 77878;
export const Juz2AvgWords = QuranWords / 30;
...
export const sura_name = ["الفاتحة", "البقرة", "آل عمران",
...
export const last5_juz_idx = [sura_idx[44], sura_idx[49], sura_idx[56], sura_idx[65], sura_idx[76], QuranWords];

export const PartWeight100 = [1, 236, 134, 145, 108, 118, 128, 48,
...
export const SurasSpecialQuestionEligibilityThreshold = 7;
